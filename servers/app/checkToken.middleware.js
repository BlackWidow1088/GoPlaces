...
let checkToken = (req, res, next) => {
  let token;
  if(req.cookies && req.cookies['goplaces']) {
    token = JSON.parse(req.cookies['goplaces'])['idToken'];
  }
  // TODO: if token saved as locally on client side and added to each request in header.
