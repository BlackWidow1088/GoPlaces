import 'package:GoPlaces/components/data.service.dart';
...
class GoPlaces extends StatelessWidget {
    ...
    return Scaffold(
      body: PageView(
        children: [
          ...
          Container(color: Colors.white, child: LiveFeedPage()),
          Container(
              color: Colors.white,
              child: ProfilePage(
